...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.login = function () {
    ...
    (function () {
        ...
        _root_decorators = [(0, common_1.Get)('login'), (0, common_1.Render)('index')];
        _login_decorators = [(0, common_1.Get)('login'), (0, common_1.Render)('login')];
